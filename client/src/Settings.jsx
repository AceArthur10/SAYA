    ...
    const update = (event) => {
      ...
      return (
        <div>
            ...
            <input type='text' className='AccName' placeholder={'< Account Name >'} onChange={(e) => {setAccount(e.target.value)}}></input>
            <input type="text" className='Mail' placeholder='< Email >' maxLength={0}></input>
            ...
            <input type='text' className='MainAcc' placeholder='< Main Account >' maxLength={0}></input>
        ...
        <input type='text' className='EmailIn' placeholder='< Email >' maxLength={0}></input>
